...
- **deps:** bump @typescript-eslint/eslint-plugin from 8.0.0 to 8.3.0 ([#1343](https://github.com/ybiquitous/eslint-config-ybiquitous/issues/1343)) ([9f4d104](https://github.com/ybiquitous/eslint-config-ybiquitous/commit/9f4d10482d4d0216214b50ceca45f89278da9957))
...
- **deps:** bump @typescript-eslint/eslint-plugin from 6.14.0 to 6.18.0 ([#1285](https://github.com/ybiquitous/eslint-config-ybiquitous/issues/1285)) ([408989d](https://github.com/ybiquitous/eslint-config-ybiquitous/commit/408989d79414ae60c83aae10dd11926259ca99cc))
- **deps:** bump @typescript-eslint/eslint-plugin from 6.18.1 to 6.20.0 ([#1292](https://github.com/ybiquitous/eslint-config-ybiquitous/issues/1292)) ([c2dff17](https://github.com/ybiquitous/eslint-config-ybiquitous/commit/c2dff170328fac5edd8391882c4356514a5e772a))
...
- **deps:** bump @typescript-eslint/eslint-plugin from `>=6.2.0` to `>=6.9.0` ([#1261](https://github.com/ybiquitous/eslint-config-ybiquitous/issues/1261)) ([cf65290](https://github.com/ybiquitous/eslint-config-ybiquitous/commit/cf652907505ca5bb6b0fe07b34a50f45360490af))
...
- **deps:** bump @typescript-eslint/eslint-plugin from 5.60.1 to 6.1.0 ([#1235](https://github.com/ybiquitous/eslint-config-ybiquitous/issues/1235)) ([8cb7ffb](https://github.com/ybiquitous/eslint-config-ybiquitous/commit/8cb7ffbc801cdab83943b8b57b373d9b514815c5))

## [17.0.0](https://github.com/ybiquitous/eslint-config-ybiquitous/compare/v16.3.0...v17.0.0) (2023-05-20)
...
- drop Node.js 14 support ([#1212](https://github.com/ybiquitous/eslint-config-ybiquitous/issues/1212)) ([ea53ff6](https://github.com/ybiquitous/eslint-config-ybiquitous/commit/ea53ff6ac20cdd179e4926731c5efa1abc193716))
- **typescript:** enable new `@typescript-eslint/*` rules ([#1211](https://github.com/ybiquitous/eslint-config-ybiquitous/issues/1211)) ([5e06964](https://github.com/ybiquitous/eslint-config-ybiquitous/commit/5e06964cb467dae7ce8a0f7268b7edb877dc6e7b))

## [16.3.0](https://github.com/ybiquitous/eslint-config-ybiquitous/compare/v16.2.0...v16.3.0) (2023-02-02)

### Features

- **deps:** bump eslint-plugin-import from 2.26.0 to 2.27.5 ([#1171](https://github.com/ybiquitous/eslint-config-ybiquitous/issues/1171)) ([02ad76e](https://github.com/ybiquitous/eslint-config-ybiquitous/commit/02ad76ec954cf0130825e50f89a2f813bf2d467c))
- **deps:** bump eslint-plugin-jsx-a11y from 6.6.1 to 6.7.1 ([#1174](https://github.com/ybiquitous/eslint-config-ybiquitous/issues/1174)) ([a9bfb34](https://github.com/ybiquitous/eslint-config-ybiquitous/commit/a9bfb34940f9e7c87c461faa17720e2abfe45acc))
- **deps:** bump eslint-plugin-react from 7.31.11 to 7.32.2 ([#1178](https://github.com/ybiquitous/eslint-config-ybiquitous/issues/1178)) ([dcd84c4](https://github.com/ybiquitous/eslint-config-ybiquitous/commit/dcd84c427acd4645c5add1138ac1f4e9b947353b))
- **deps:** bump eslint-plugin-regexp from 1.11.0 to 1.12.0 ([#1183](https://github.com/ybiquitous/eslint-config-ybiquitous/issues/1183)) ([b60d40e](https://github.com/ybiquitous/eslint-config-ybiquitous/commit/b60d40e4ad2dc221c71e6a7285d246102113b6b2))

### Bug Fixes

- **deps:** bump @typescript-eslint/eslint-plugin from 5.48.0 to 5.50.0 ([#1177](https://github.com/ybiquitous/eslint-config-ybiquitous/issues/1177)) ([b96410b](https://github.com/ybiquitous/eslint-config-ybiquitous/commit/b96410b74f6370f66589157dab66bb2351c956ed))
...
- **deps:** bump @typescript-eslint/eslint-plugin from 5.38.1 to 5.42.0 ([#1147](https://github.com/ybiquitous/eslint-config-ybiquitous/issues/1147)) ([ed7c008](https://github.com/ybiquitous/eslint-config-ybiquitous/commit/ed7c008a6f7a6d4afe5ef9535800fc713d8026ea))
...
- **deps:** bump @typescript-eslint/eslint-plugin from 5.21.0 to 5.27.0 ([#1092](https://github.com/ybiquitous/eslint-config-ybiquitous/issues/1092)) ([4822223](https://github.com/ybiquitous/eslint-config-ybiquitous/commit/4822223375fce6f89da50c5fb037c1b317c30653))
- **deps:** bump eslint-plugin-react from 7.29.4 to 7.30.0 ([#1091](https://github.com/ybiquitous/eslint-config-ybiquitous/issues/1091)) ([e1689ec](https://github.com/ybiquitous/eslint-config-ybiquitous/commit/e1689ec3df51f03c273a3be9e74ddc2a80183ed2))
...
- **deps:** bump @typescript-eslint/eslint-plugin from 5.10.2 to 5.13.0 ([#1058](https://github.com/ybiquitous/eslint-config-ybiquitous/issues/1058)) ([fc45370](https://github.com/ybiquitous/eslint-config-ybiquitous/commit/fc45370dc62d7dd26916b73d4a6317c00e97a8f4))
- **deps:** bump eslint from 8.3.0 to 8.6.0 ([#1033](https://github.com/ybiquitous/eslint-config-ybiquitous/issues/1033)) ([c8a133e](https://github.com/ybiquitous/eslint-config-ybiquitous/commit/c8a133edf77014b31a337c4a84b5ee663bfd6630))
- **deps:** bump eslint-config-prettier from 8.4.0 to 8.5.0 ([#1059](https://github.com/ybiquitous/eslint-config-ybiquitous/issues/1059)) ([09f9828](https://github.com/ybiquitous/eslint-config-ybiquitous/commit/09f98287245a055cf3f4fed86244710900751dcd))
- **deps:** bump eslint-plugin-react from 7.28.0 to 7.29.2 ([#1052](https://github.com/ybiquitous/eslint-config-ybiquitous/issues/1052)) ([248b5c5](https://github.com/ybiquitous/eslint-config-ybiquitous/commit/248b5c57dce5613568ae850111d26250c360f45f))
...
- **deps:** bump @typescript-eslint/eslint-plugin from 4.31.0 to 4.32.0 ([#988](https://github.com/ybiquitous/eslint-config-ybiquitous/issues/988)) ([1703a15](https://github.com/ybiquitous/eslint-config-ybiquitous/commit/1703a150521a425399e6ac2a9e08dd0983701dad))
- **deps:** bump eslint-plugin-react from 7.25.1 to 7.26.0 ([#986](https://github.com/ybiquitous/eslint-config-ybiquitous/issues/986)) ([947ae6d](https://github.com/ybiquitous/eslint-config-ybiquitous/commit/947ae6dc971f421c57c90ca4447f48494c7f57ac))
- **regexp:** bump eslint-plugin-regexp from 1.1.0 to 1.3.1 ([#985](https://github.com/ybiquitous/eslint-config-ybiquitous/issues/985)) ([f7bea29](https://github.com/ybiquitous/eslint-config-ybiquitous/commit/f7bea29c4fbd19fd2766698f88b4baf9b30f675a))

## [14.2.0](https://github.com/ybiquitous/eslint-config-ybiquitous/compare/v14.1.0...v14.2.0) (2021-09-13)

### Features

- **deps:** bump @typescript-eslint/eslint-plugin from 4.30.0 to 4.31.0 ([#976](https://github.com/ybiquitous/eslint-config-ybiquitous/issues/976)) ([f796e3b](https://github.com/ybiquitous/eslint-config-ybiquitous/commit/f796e3b35fdae1690045483030b39d21036d2105))
